...
namespace Appacitive.Sdk.Services
{
    public class FindAllArticleRequest : GetOperation<FindAllArticleResponse>
    {
        ...
        public FindAllArticleRequest(string apiKey, string sessionToken, Environment environment, string userToken = null, Geocode location = null, bool enableDebugging = false, Verbosity verbosity = Verbosity.Info) :
