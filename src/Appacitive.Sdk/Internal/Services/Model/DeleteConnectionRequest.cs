...
namespace Appacitive.Sdk.Services
{
    public class DeleteConnectionRequest : DeleteOperation<DeleteConnectionResponse>
    {
        ...
        public DeleteConnectionRequest(string apiKey, string sessionToken, Environment environment, string userToken = null, Geocode location = null, bool enableDebugging = false, Verbosity verbosity = Verbosity.Info) :
