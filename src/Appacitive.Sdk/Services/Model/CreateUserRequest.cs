...
namespace Appacitive.Sdk.Services
{
    public class CreateUserRequest : ApiRequest
    {
        ...
        public CreateUserRequest(string sessionToken, Environment environment, string userToken = null, Geocode location = null, bool enableDebugging = false, Verbosity verbosity = Verbosity.Info) :
