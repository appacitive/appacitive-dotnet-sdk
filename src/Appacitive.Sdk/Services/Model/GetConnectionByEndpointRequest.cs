...
{
    public class GetConnectionByEndpointRequest : ApiRequest
    {
        ...
        public GetConnectionByEndpointRequest(string sessionToken, Environment environment, string userToken = null, Geocode location = null, bool enableDebugging = false, Verbosity verbosity = Verbosity.Info) :
